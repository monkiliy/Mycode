...
var CompressPlugin = function () {
  function CompressPlugin() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, CompressPlugin);
        ...
        compilation.plugin('html-webpack-plugin-after-html-processing', function (htmlPluginData, callback) {
          ...
          _async2.default.forEach(Object.keys(assets), function (file, cb) {
            ...
            _this.algorithm(content, _this.compressionOptions, function (err, result) {
              ...
              htmlPluginData.html = htmlPluginData.html.replace(file, newFile);
              cb();
            });
          }, callback);
        });
...
exports.default = CompressPlugin;